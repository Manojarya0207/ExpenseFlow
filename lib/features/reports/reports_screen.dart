        ...
        child: Column(
          children: <Widget>[
            ...
            _row(context, 'Expense',
                ...
                AppColors.expense),
            const Divider(height: 20),
            _row(context, 'Savings (This Month)',
                Formatters.money(summary.savings, symbol), AppColors.savings),
            const Divider(height: 20),
            _row(context, 'Carried Forward',
                Formatters.money(summary.carryForward, symbol),
                AppColors.primary),
            const Divider(height: 20),
            _row(context, 'Total Balance',
                Formatters.money(summary.remainingBalance, symbol),
                AppColors.primary),
          ],
        ),
      ),
